...
namespace AccController.Request_Ais.Pages
{
    ...
    using MyController = AccController.Request_Ais.Endpoints.AisUserController;
    ...
    public class AisUserController : Controller
    {
        ...
        public ActionResult GetRequestFile(string status)
        {
            ...
            {
                var spsHelper = new SpreedSheetHelper(Server.MapPath("~/Content/templates/export/result/ais/TaoMoiNguoiDung.xlsx"));
        ...
        public ActionResult GetResultFromFile(string status)
        {
            ...
            try
            {
                ...
                var spsHelper = new SpreedSheetHelper(Server.MapPath("~/Content/templates/import/result/ais/TaoMoiNguoiDung.xlsx"));
                    ...
                    var fileRowResponse = this.InTransaction("Default", (uow) =>
                    {
                        ...
                        if (saveFileResponse.EntityId.HasValue)
                        {
                            foreach (var item in list.Entities)
                            {
                                ...
                                var saveresponse = new AisUserRepository().UpdateResult(uow, new SaveRequest<MyRow>
                                {
                                    Entity = item
                                });
