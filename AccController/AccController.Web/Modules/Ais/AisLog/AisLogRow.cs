...
namespace AccController.Ais.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("AisLog"), InstanceName("AisLog"), TwoLevelCached]
    [ReadPermission("AisLog")]
    [ModifyPermission("AisLog")]
    [JsonConverter(typeof(JsonRowConverter))]
    public sealed class AisLogRow : Row, IIdRow, INameRow
    {
