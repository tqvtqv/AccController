...
namespace AccController
{
    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                public static class Login
                {
                    ...
                    public static LocalText RegisterLink = "Register";
                }
                public static class Register
                {
                    public static LocalText FormTitle = "Register local user";
                    //public static LocalText SignInButton = "Sign In";
                    public static LocalText RegisterButton = "Register";
                }
            }
        }
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "AccController";
        }
