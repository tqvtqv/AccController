...
namespace AccController.Request_Ais
{
    ...
    [ColumnsKey("Request_Ais.AisUserChangeInfo"), IdProperty(AisUserChangeInfoRow.IdProperty), NameProperty(AisUserChangeInfoRow.NameProperty)]
    [DialogType(typeof(AisUserChangeInfoDialog)), LocalTextPrefix(AisUserChangeInfoRow.LocalTextPrefix), Service(AisUserChangeInfoService.BaseUrl)]
