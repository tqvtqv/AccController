...
namespace AccController.Request_Ais
{
    ...
    [ColumnsKey("Request_Ais.AisUserChangeOU"), IdProperty(AisUserChangeOURow.IdProperty), NameProperty(AisUserChangeOURow.NameProperty)]
    [DialogType(typeof(AisUserChangeOUDialog)), LocalTextPrefix(AisUserChangeOURow.LocalTextPrefix), Service(AisUserChangeOUService.BaseUrl)]
