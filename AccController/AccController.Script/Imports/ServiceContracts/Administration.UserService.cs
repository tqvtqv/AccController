...
namespace AccController.Administration
{
    ...
    public partial class UserService
    {
        ...
        [InlineCode("Q.serviceRequest('Administration/User/updateuser', {para1}, {onSuccess}, {options})")]
        public static jQueryXmlHttpRequest updateuser(SaveRequest<UserRow> para1, Action<SaveResponse> onSuccess, ServiceCallOptions options = null)
        {
            return null;
        }
        ...
        public static class Methods
        {
            ...
            [InlineConstant] public const string updateuser = "Administration/User/updateuser";
